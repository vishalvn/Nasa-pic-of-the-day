...
import com.vv.nasapod.databinding.ScreenVideoViewBinding
...
class VideoViewScreen : Fragment(R.layout.screen_video_view) {
    ...
    @Inject lateinit var nasaAPODViewModelFactory: NasaPODViewModelFactory
    @Inject lateinit var picasso: Picasso
    private lateinit var binding: ScreenVideoViewBinding
    private lateinit var videoLoadDisposable : Disposable
    private val nasaAPODViewModel: NasaPODViewModel by navGraphViewModels(R.id.nav_main) { nasaAPODViewModelFactory }
